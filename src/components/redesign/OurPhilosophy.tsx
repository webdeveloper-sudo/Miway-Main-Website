  ...
  return (
    <div className="relative flex flex-col lg:flex-row items-center gap-16 md:gap-24">
      ...
      <div className="flex-1 order-2 lg:order-1 items-start">
        ...
        >
          ...
          <p className="text-md text-muted font-medium font-serif max-w-2xl mx-auto mb-4">
            {getContent(
              "phil_desc_1",
              "MIWAY Teaching Aids was born from a singular conviction: that every child carries within them an extraordinary potential waiting to be ignited — not with rote memorization, but with purposeful, joyful, whole-brain learning.",
            )}
          </p>
      ...
      "
          >
            {/* Mission Label */}
            <div className="inline-flex items-center justify-center border border-accent border-2 px-3 sm:px-5 py-1 sm:py-2 mb-3">
              <span className="text-[10px] sm:text-[11px] uppercase tracking-[0.3em] text-white font-semibold">
                {getContent("phil_mission_tag", "Mission")}
              </span>
            </div>

            {/* Mission Text */}
            <p className="text-[11px] sm:text-[13px] leading-[1.7] sm:leading-[2] text-white/80 font-medium">
              {getContent(
                "phil_mission_desc",
