...
const MasterySpiral = ({ content = {} }: MasterySpiralProps) => {
  ...
  return (
    <div className="relative w-full max-w-2xl mx-auto aspect-square flex items-center justify-center p-2 sm:p-8 overflow-hidden">
      <div className="relative w-full h-full flex items-center justify-center scale-[0.68] sm:scale-[0.85] md:scale-100 transition-transform duration-500">
        {/* Background Rings */}
        {levels.map((level, i) => (
          <motion.div
            key={i}
