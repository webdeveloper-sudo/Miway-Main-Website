    ...
    <AnimatePresence>
      {isOpen && item && (
        ...
        >
          ...
          <motion.button
            onClick={onClose}
            className="absolute top-4 right-4 text-white hover:text-gray-400 z-[1010]"
          >
            <X size={32} />
          </motion.button>
          ...
          <motion.button
            onClick={onPrev}
            className="absolute left-6 text-white hover:text-gray-300 z-[1010]"
          >
            <ChevronLeft size={48} />
          </motion.button>
          ...
          >
            <motion.img
              ...
              src={item.image}
              alt={item.imgTitle}
              className="max-h-[80vh] max-w-[85vw] object-contain cursor-zoom-in"
              animate={{ scale: zoom }}
          ...
          <motion.button
            onClick={onNext}
            className="absolute right-6 text-white hover:text-gray-300 z-[1010]"
          >
