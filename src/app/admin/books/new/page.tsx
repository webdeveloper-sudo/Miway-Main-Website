...
export default async function NewBookPage() {
 ...
 <h1 className="text-2xl font-black text-gray-800 tracking-tighter mb-2 ">Initialize Asset</h1>
 <p className="text-gray-500 font-bold uppercase tracking-wider text-xs">Create New Book</p>
 </div>
 ...
 <form action={createBook} className="space-y-8 relative z-10">
