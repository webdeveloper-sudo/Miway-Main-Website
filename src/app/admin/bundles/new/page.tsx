...
export default function NewBundlePage() {
 ...
 <div className="mb-10">
 <Link href="/admin/bundles" className="inline-flex items-center gap-2 text-gray-500 hover:text-gray-800 transition-colors mb-6 group">
 <ArrowLeft size={16} className="group-hover:-translate-x-1 transition-transform" />
 <span className="text-xs font-bold uppercase tracking-widest">Abort & Return</span>
 </Link>
 <h1 className="text-2xl font-black text-gray-800 tracking-tighter mb-2 ">Initialize Sequence</h1>
 <p className="text-gray-500 font-bold uppercase tracking-wider text-xs">Create New Curriculum Module</p>
 </div>
 ...
 <label className="text-sm font-black uppercase tracking-wider text-gray-500 ml-1">Module Identity</label>
 ...
 <div className="space-y-2">
 <label className="text-sm font-black uppercase tracking-wider text-gray-500 ml-1">Target Sector</label>
 ...
 >
 <option value="" className="bg-white text-gray-500">Select Grade Sector</option>
 <option value="Nursey - KG" className="bg-white">Preschool (Nursery - KG)</option>
 <option value="Grades 1-5" className="bg-white">Primary (Grades 1-5)</option>
 <option value="Grades 6-8" className="bg-white">Middle School (Grades 6-8)</option>
 <option value="Grades 9-10" className="bg-white">High School (Grades 9-10)</option>
 </select>
 ...
 Core Components <span className="text-gray-600 normal-case tracking-normal">(Comma separated)</span>
 </label>
 <input
 type="text"
 name="subjects"
 ...
 <div className="space-y-2">
 <label className="text-sm font-black uppercase tracking-wider text-gray-500 ml-1">
 Technical Specifications <span className="text-gray-600 normal-case tracking-normal">(One per line)</span>
 </label>
 <textarea
 name="features"
 rows={5}
 ...
 <Link href="/admin/bundles" className="text-xs font-bold uppercase tracking-widest text-gray-500 hover:text-gray-800 transition-colors">
 Cancel
 </Link>
