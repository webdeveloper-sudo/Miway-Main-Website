...
export default async function EditBundlePage({ params }: { params: { id: string } }) {
 ...
 <h1 className="text-2xl font-black text-gray-800 tracking-tighter mb-2 ">Modify Sequence</h1>
 <p className="text-gray-500 font-bold uppercase tracking-wider text-xs">Update Curriculum Module</p>
 </div>
