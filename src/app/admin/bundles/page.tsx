    ...
    <div>
        ...
        <div className="mb-6 p-4 bg-green-50/80 border border-green-200 text-green-700 rounded-lg flex items-center justify-between animate-in fade-in slide-in-from-top-4">
          <div className="flex items-center gap-3">
            ...
            <span className="font-bold text-sm">
              Sequence modified successfully. System state updated.
            </span>
          </div>
        </div>
      )}
      <div className="flex justify-between items-end mb-12">
        ...
        <Link
          ...
          className="flex items-center gap-3 px-6 py-3 bg-primary border border-primary/50 text-white rounded-lg text-sm font-bold hover:bg-primary-hover hover:scale-105 transition-all shadow-[0_0_20px_var(--primary-glow)]"
        >
          <Plus size={20} />
          ...
          <table className="w-full text-left">
            <thead>
              <tr className="border-b border-gray-200/60">
                <th className="p-8 text-sm font-black uppercase tracking-wider text-gray-500">
                  Module Identity
                </th>
                <th className="p-8 text-sm font-black uppercase tracking-wider text-gray-500">
                  Target Grade
                ...
                <th className="p-8 text-sm font-black uppercase tracking-wider text-gray-500 text-right">
                  Protocols
                </th>
              </tr>
            </thead>
            <tbody className="divide-y divide-slate-100">
              {bundles.map((bundle) => (
                ...
                >
                  <td className="p-8">
                    <div className="font-black text-gray-800 text-2xl tracking-tight group-hover:text-primary transition-colors ">
                      {bundle.title}
                    </div>
                  ...
                  <td className="p-8 text-gray-500 font-bold">
                    {bundle._count.books}{" "}
                    <span className="text-gray-500 text-xs uppercase tracking-widest pl-2">
                      Books
                    </span>
                  </td>
                  <td className="p-8">
                    <div className="flex gap-3 justify-end opacity-60 group-hover:opacity-100 transition-opacity">
                      <Link
                        ...
                        className="p-3 text-gray-500 hover:text-primary hover:bg-primary/10 rounded-lg transition-all border border-transparent hover:border-primary/20"
                      >
                        <Edit size={18} />
                      </Link>
